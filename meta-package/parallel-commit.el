...
;; (_mc-get-files-that-changed-since-commit "b97bc78d669e6eaea794eb36f2d9f4cb9ff94a45")
;; (let ((default-directory "~/p/chronos-crm/")) (_mc-get-files-that-changed-since-commit "b97bc78d669e6eaea794eb36f2d9f4cb9ff94a45"))
;; (let ((default-directory "~/p/chronos-crm/")) (_mc-get-files-that-changed-since-commit (_mc-get-last-sync-meta-hash)))
...
;; ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; ;;
;; HAVING PARALLEL COMMIT IGNORE META FOLDER ;;
;; ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; ;;
;;
...
(defun mc-copy-meta-folder-to-temp-folder ()
  ...
  (message (concat "cp -rf " (_mc-get-git-root-dir) "meta " _mc-directory-for-copying-not-filtered-files))
  )
...
(defun mc-parallel-commit-1 ()
  ...
  (let* (
    ...
    (mc-copy-meta-folder-to-temp-folder)
	...
	(progn
	  ...
	  (shell-command (concat "mkdir -p " (_mc-get-git-root-dir) "meta/"))
	  ...
	  (shell-command (concat "rm -r " _mc-directory-for-copying-not-filtered-files))
